...
#Vertici
param N := read "C:\Users\Rivan\Documents\Uni\Tesi\RICOPstuff\Test\input.txt" as "1n" skip 1 use 1;
set V := { 1 .. N };
#Archi
set A :={read "C:\Users\Rivan\Documents\Uni\Tesi\RICOPstuff\Test\input.txt" as "<1n,2n>" skip 2};
#Dimensione di B
